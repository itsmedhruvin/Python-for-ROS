...
: ${AMENT_CURRENT_PREFIX:="/home/user/simulation_ws/install/fastbot_realrobot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fastbot_realrobot/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fastbot_realrobot/environment/path.sh"
